...
fu! s:Define_syntax()
	...
	" Last update: Sun Jul 31 15:15:31 2016
	...
	while ip <= b:txtfmt_cfg_numfgcolors
		...
		exe 'syn region Tf'.cui.'_clr_'.i
			\.' start=/'.chi.'/'
			\.skip
			\.' contains='.Tf_tok_group
			\.(b:txtfmt_cfg_escape != 'none'
			\	? ',Tf_any_stok_inner_esc,Tf_clr_etok_inner_esc'
			\	: '')
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j
				...
				\.' contains='.Tf_tok_group
				\.(b:txtfmt_cfg_escape != 'none'
				\	? ',Tf_any_stok_inner_esc,Tf_clr_etok_inner_esc,Tf_bgc_etok_inner_esc'
				\	: '')
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_clr_etok_inner_esc,Tf_bgc_etok_inner_esc,Tf_fmt_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_bgcfmt_'.j.'_'.k.',Tf'.cui.'_clrfmt_'.i.'_'.k.',Tf'.cui.'_clrbgc_'.i.'_'.j.',@Tf'.cui.'_bgcfmtclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j
				...
				\.' contains='.Tf_tok_group
				\.(b:txtfmt_cfg_escape != 'none'
				\	? ',Tf_any_stok_inner_esc,Tf_clr_etok_inner_esc,Tf_fmt_etok_inner_esc'
				\	: '')
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_clr_etok_inner_esc,Tf_fmt_etok_inner_esc,Tf_bgc_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_fmtbgc_'.j.'_'.k.',Tf'.cui.'_clrbgc_'.i.'_'.k.',Tf'.cui.'_clrfmt_'.i.'_'.j.',@Tf'.cui.'_fmtbgcclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while ip <= b:txtfmt_cfg_numbgcolors
		...
		exe 'syn region Tf'.cui.'_bgc_'.i
			...
			\.' contains='.Tf_tok_group
			\.(b:txtfmt_cfg_escape != 'none'
			\	? ',Tf_any_stok_inner_esc,Tf_bgc_etok_inner_esc'
			\	: '')
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_bgc_etok_inner_esc,Tf_clr_etok_inner_esc,Tf_fmt_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_clrfmt_'.j.'_'.k.',Tf'.cui.'_bgcfmt_'.i.'_'.k.',Tf'.cui.'_bgcclr_'.i.'_'.j.',@Tf'.cui.'_clrfmtbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j
				...
				\.' contains='.Tf_tok_group
				\.(b:txtfmt_cfg_escape != 'none'
				\	? ',Tf_any_stok_inner_esc,Tf_bgc_etok_inner_esc,Tf_fmt_etok_inner_esc'
				\	: '')
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_bgc_etok_inner_esc,Tf_fmt_etok_inner_esc,Tf_clr_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_fmtclr_'.j.'_'.k.',Tf'.cui.'_bgcclr_'.i.'_'.k.',Tf'.cui.'_bgcfmt_'.i.'_'.j.',@Tf'.cui.'_fmtclrbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while i <= b:txtfmt_num_formats - 1
		...
		exe 'syn region Tf'.cui.'_fmt_'.i
			...
			\.' contains='.Tf_tok_group
			\.(b:txtfmt_cfg_escape != 'none'
			\	? ',Tf_any_stok_inner_esc,Tf_fmt_etok_inner_esc'
			\	: '')
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j
				...
				\.' contains='.Tf_tok_group
				\.(b:txtfmt_cfg_escape != 'none'
				\	? ',Tf_any_stok_inner_esc,Tf_fmt_etok_inner_esc,Tf_clr_etok_inner_esc'
				\	: '')
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_fmt_etok_inner_esc,Tf_clr_etok_inner_esc,Tf_bgc_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_clrbgc_'.j.'_'.k.',Tf'.cui.'_fmtbgc_'.i.'_'.k.',Tf'.cui.'_fmtclr_'.i.'_'.j.',@Tf'.cui.'_clrbgcfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j
				...
				\.' contains='.Tf_tok_group
				\.(b:txtfmt_cfg_escape != 'none'
				\	? ',Tf_any_stok_inner_esc,Tf_fmt_etok_inner_esc,Tf_bgc_etok_inner_esc'
				\	: '')
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_'.k
					...
					\.' contains='.Tf_tok_group
					\.(b:txtfmt_cfg_escape != 'none'
					\	? ',Tf_any_stok_inner_esc,Tf_fmt_etok_inner_esc,Tf_bgc_etok_inner_esc,Tf_clr_etok_inner_esc'
					\	: '')
					...
					\.' nextgroup=Tf'.cui.'_bgcclr_'.j.'_'.k.',Tf'.cui.'_fmtclr_'.i.'_'.k.',Tf'.cui.'_fmtbgc_'.i.'_'.j.',@Tf'.cui.'_bgcclrfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_all'.' contained'
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		if ($section == DEFS) {
			...
			if (@a2n) {
				...
				print "$pre_start",
					...
					join(".", map { "b:txtfmt_re_" . $_ . "_etok_atom" } @a1n),
					".']/me=e-'.tok_off.',he=e-'.tok_off",
					# TODO: Use @a2n and convert bgc to special form.
					"\n$il\t\\.' start=/['.",
					join(".", map {
