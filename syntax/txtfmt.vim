...
fu! s:Define_syntax()
	...
	if b:txtfmt_cfg_nested
		...
		" NMG_TODO: Don't use pattern for the conceal groups.
		if b:txtfmt_cfg_escape != 'none'
			let containedin_def = ' containedin=ALLBUT,Tf.*conceal.*,@Tf'.cui.'_all,Tf_def_tok'
	...
	let matchgroup_top_def = 'Tf_conceal'
	...
	" Last update: Sat Jun  4 09:57:46 2016
	...
	while ip <= b:txtfmt_cfg_numfgcolors
		...
		exe 'syn region Tf'.cui.'_clr_'.i
			\.' start=/'.chi.'/'.r1_clr.' contains='.matchgroup_def.ng.concealends
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_clr_'.i.'_rtd'
			\.r2_clr.' contains='.matchgroup_def.ng.concealends
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			let matchgroup_def = 'Tf'.cui.'_conceal_'.j
			...
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrbgc.' contains='.matchgroup_def.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j.'_rtd'
				\.r2_clrbgc.' contains='.matchgroup_def.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrbgcfmt.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_bgcfmt_'.j.'_'.k.'_rtd,Tf'.cui.'_clrfmt_'.i.'_'.k.'_rtd,Tf'.cui.'_clrbgc_'.i.'_'.j.'_rtd,@Tf'.cui.'_bgcfmtclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrfmt.' contains='.matchgroup_def.ng.concealends
			...
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j.'_rtd'
				\.r2_clrfmt.' contains='.matchgroup_def.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				" Ensure that this and higher order regions use bgc-specific concealment group
				let matchgroup_def = 'Tf'.cui.'_conceal_'.k
				...
				exe 'syn region Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrfmtbgc.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_fmtbgc_'.j.'_'.k.'_rtd,Tf'.cui.'_clrbgc_'.i.'_'.k.'_rtd,Tf'.cui.'_clrfmt_'.i.'_'.j.'_rtd,@Tf'.cui.'_fmtbgcclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while ip <= b:txtfmt_cfg_numbgcolors
		...
		" Ensure that this and higher order regions use bgc-specific concealment group
		let matchgroup_def = 'Tf'.cui.'_conceal_'.i
		...
		exe 'syn region Tf'.cui.'_bgc_'.i
			\.' start=/'.chi.'/'.r1_bgc.' contains='.matchgroup_def.ng.concealends
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_bgc_'.i.'_rtd'
			\.r2_bgc.' contains='.matchgroup_def.ng.concealends
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		" handled correctly in a cterm.
		"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcclr.' contains='.matchgroup_def.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j.'_rtd'
				\.r2_bgcclr.' contains='.matchgroup_def.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcclrfmt.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_clrfmt_'.j.'_'.k.'_rtd,Tf'.cui.'_bgcfmt_'.i.'_'.k.'_rtd,Tf'.cui.'_bgcclr_'.i.'_'.j.'_rtd,@Tf'.cui.'_clrfmtbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcfmt.' contains='.matchgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j.'_rtd'
				\.r2_bgcfmt.' contains='.matchgroup_def.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcfmtclr.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_fmtclr_'.j.'_'.k.'_rtd,Tf'.cui.'_bgcclr_'.i.'_'.k.'_rtd,Tf'.cui.'_bgcfmt_'.i.'_'.j.'_rtd,@Tf'.cui.'_fmtclrbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while i <= b:txtfmt_num_formats - 1
		...
		exe 'syn region Tf'.cui.'_fmt_'.i
			\.' start=/'.chi.'/'.r1_fmt.' contains='.matchgroup_def.ng.concealends
		" Define the following region if and only if at least one of the
		" region types whose end token could begin this region is active
		"============= BEGIN NON-INDENTING BLOCK =============
		if clr_enabled || bgc_enabled
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_fmt_'.i.'_rtd'
			\.r2_fmt.' contains='.matchgroup_def.ng.concealends
		endif " clr_enabled || bgc_enabled
		"=============  END NON-INDENTING BLOCK  =============
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtclr.' contains='.matchgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if bgc_enabled
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j.'_rtd'
				\.r2_fmtclr.' contains='.matchgroup_def.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtclrbgc.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_clrbgc_'.j.'_'.k.'_rtd,Tf'.cui.'_fmtbgc_'.i.'_'.k.'_rtd,Tf'.cui.'_fmtclr_'.i.'_'.j.'_rtd,@Tf'.cui.'_clrbgcfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtbgc.' contains='.matchgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j.'_rtd'
				\.r2_fmtbgc.' contains='.matchgroup_def.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtbgcclr.' contains='.matchgroup_def.' nextgroup=Tf'.cui.'_bgcclr_'.j.'_'.k.'_rtd,Tf'.cui.'_fmtclr_'.i.'_'.k.'_rtd,Tf'.cui.'_fmtbgc_'.i.'_'.j.'_rtd,@Tf'.cui.'_bgcclrfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
...
fu! s:Define_syntax_syncing()
	...
	if b:txtfmt_cfg_nested
		...
		" syntax group (e.g. C-language comment).
		if b:txtfmt_cfg_escape != 'none'
			let containedin_def = ' containedin=ALLBUT,Tf0_conceal_1,Tf0_conceal_2,Tf0_conceal_3,Tf0_conceal_4,@Tf_all,Tf_outer_esc,Tf_inner_esc'
		else
			let containedin_def = ' containedin=ALLBUT,Tf0_conceal_1,Tf0_conceal_2,Tf0_conceal_3,@Tf_all'
		endif
	else
		let containedin_def = ''
	endif
	...
	for my $a2 (@a2) {
		...
		if ($section == DEFS) {
			...
			if ($a1n[-1] eq 'bgc') {
				...
				print "\n$il", "let matchgroup_def = 'Tf'.cui.'_conceal_'.$idx{$a1n[-1]}";
			...
			$contains = "' contains='.matchgroup_def";
			...
			print "$pre_start",
				...
				".r1_", join("", @a1n), ".$contains.$ng.concealends";
			...
			if (@a2n) {
				...
				print "$pre_start.'_rtd'\n$il\t\\.",
					"r2_", join("", @a1n), ".$contains.$ng.concealends";
				;
				if ($need_r2_guard) {
					print "\n$il", "endif \" ",
						join ' || ', map { "${_}_enabled" } @a2n;
