...
fu! s:Define_syntax()
	...
	" Note: In 'noconceal' case, bgc-specific groups will be added later.
	exe 'syn cluster Tf'.cui.'_conceal contains=Tf_conceal'
	...
	" Last update: Thu Aug  4 13:52:26 2016
	...
	if b:txtfmt_cfg_escape == 'bslash' || b:txtfmt_cfg_escape == 'self'
		...
		if !b:txtfmt_cfg_conceal
			...
			" groups; however, we could create/use it unconditionally for
			" simplicity. TODO: Decide...
