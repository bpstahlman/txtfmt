...
fu! s:Define_syntax()
	...
	let concealgroup_top_def = 'Tf_conceal'
	let concealgroup_def = concealgroup_top_def
	...
	" Last update: Sat Jul  9 10:44:53 2016
	...
	while ip <= b:txtfmt_cfg_numfgcolors
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			let concealgroup_def = 'Tf'.cui.'_conceal_'.j
			...
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrbgc.' contains='.concealgroup_def.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j.'_rtd'
				\.r2_clrbgc.' contains='.concealgroup_def.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrbgcfmt.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_bgcfmt_'.j.'_'.k.'_rtd,Tf'.cui.'_clrfmt_'.i.'_'.k.'_rtd,Tf'.cui.'_clrbgc_'.i.'_'.j.'_rtd,@Tf'.cui.'_bgcfmtclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrfmt.' contains='.concealgroup_def.ng.concealends
			...
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j.'_rtd'
				\.r2_clrfmt.' contains='.concealgroup_def.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				" Ensure that this and higher order regions use bgc-specific concealment group
				let concealgroup_def = 'Tf'.cui.'_conceal_'.k
				...
				exe 'syn region Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrfmtbgc.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_fmtbgc_'.j.'_'.k.'_rtd,Tf'.cui.'_clrbgc_'.i.'_'.k.'_rtd,Tf'.cui.'_clrfmt_'.i.'_'.j.'_rtd,@Tf'.cui.'_fmtbgcclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while ip <= b:txtfmt_cfg_numbgcolors
		...
		" Ensure that this and higher order regions use bgc-specific concealment group
		let concealgroup_def = 'Tf'.cui.'_conceal_'.i
		...
		exe 'syn region Tf'.cui.'_bgc_'.i
			\.' start=/'.chi.'/'.r1_bgc.' contains='.concealgroup_def.ng.concealends
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_bgc_'.i.'_rtd'
			\.r2_bgc.' contains='.concealgroup_def.ng.concealends
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		" handled correctly in a cterm.
		"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcclr.' contains='.concealgroup_def.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j.'_rtd'
				\.r2_bgcclr.' contains='.concealgroup_def.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcclrfmt.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_clrfmt_'.j.'_'.k.'_rtd,Tf'.cui.'_bgcfmt_'.i.'_'.k.'_rtd,Tf'.cui.'_bgcclr_'.i.'_'.j.'_rtd,@Tf'.cui.'_clrfmtbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcfmt.' contains='.concealgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			...
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j.'_rtd'
				\.r2_bgcfmt.' contains='.concealgroup_def.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcfmtclr.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_fmtclr_'.j.'_'.k.'_rtd,Tf'.cui.'_bgcclr_'.i.'_'.k.'_rtd,Tf'.cui.'_bgcfmt_'.i.'_'.j.'_rtd,@Tf'.cui.'_fmtclrbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while i <= b:txtfmt_num_formats - 1
		...
		exe 'syn region Tf'.cui.'_fmt_'.i
			\.' start=/'.chi.'/'.r1_fmt.' contains='.concealgroup_def.ng.concealends
		" Define the following region if and only if at least one of the
		" region types whose end token could begin this region is active
		"============= BEGIN NON-INDENTING BLOCK =============
		if clr_enabled || bgc_enabled
		...
		exe 'syn region Tf'.cui.'_fmt_'.i.'_rtd'
			\.r2_fmt.' contains='.concealgroup_def.ng.concealends
		endif " clr_enabled || bgc_enabled
		"=============  END NON-INDENTING BLOCK  =============
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtclr.' contains='.concealgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if bgc_enabled
			...
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j.'_rtd'
				\.r2_fmtclr.' contains='.concealgroup_def.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtclrbgc.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_clrbgc_'.j.'_'.k.'_rtd,Tf'.cui.'_fmtbgc_'.i.'_'.k.'_rtd,Tf'.cui.'_fmtclr_'.i.'_'.j.'_rtd,@Tf'.cui.'_clrbgcfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtbgc.' contains='.concealgroup_def.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			...
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j.'_rtd'
				\.r2_fmtbgc.' contains='.concealgroup_def.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtbgcclr.' contains='.concealgroup_def.' nextgroup=Tf'.cui.'_bgcclr_'.j.'_'.k.'_rtd,Tf'.cui.'_fmtclr_'.i.'_'.k.'_rtd,Tf'.cui.'_fmtbgc_'.i.'_'.j.'_rtd,@Tf'.cui.'_bgcclrfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	for my $a2 (@a2) {
		...
		if ($section == DEFS) {
			...
			if ($a1n[-1] eq 'bgc') {
				...
				print "\n$il", "let concealgroup_def = 'Tf'.cui.'_conceal_'.$idx{$a1n[-1]}";
			...
			$contains = "' contains='.concealgroup_def";
		...
		if (my ($typ) = grep { $_ eq $a1n[-1] } @can_dsbl) {
			if ($typ eq 'bgc') {
				...
				print "\n$il", "let concealgroup_def = concealgroup_top_def" if $section eq LOOPS;
			}
