...
fu! s:Define_syntax()
	...
	if b:txtfmt_cfg_conceal
		...
		" TODO: Get rid of this everywhere since no longer needed...
		let concealends = ''
		let conceal = ' conceal'
	else
		let concealends = ''
	...
	exe 'syn match Tf_tok /'.b:txtfmt_re_any_tok.'/ contained transparent contains=NONE'.conceal
	" >>>
	...
	if b:txtfmt_cfg_nested
		...
		if b:txtfmt_cfg_escape != 'none'
			let containedin_def = ' containedin=ALLBUT,Tf.*conceal.*,@Tf'.cui.'_all'
						\.',Tf_outer_esc,Tf_any_stok_inner_esc,Tf_tok'
						\.(clr_enabled ? ',Tf_clr_etok_inner_esc' : '')
						\.(bgc_enabled ? ',Tf_bgc_etok_inner_esc' : '').',Tf_fmt_etok_inner_esc'
		else
			let containedin_def = ' containedin=ALLBUT,Tf.*conceal.*,@Tf'.cui.'_all,Tf_tok'
		endif
	else
		let containedin_def = ''
	endif
	...
	" default token.
	" TODO: I'm thinking this shouldn't be needed any longer...
	...
	" Last update: Sat Jul 16 07:33:19 2016
	...
	while ip <= b:txtfmt_cfg_numfgcolors
		...
		let ng = ' nextgroup=@Tf'.cui.'_clr_all'.(bgc_enabled ? ',@Tf'.cui.'_clrbgc_'.i.'_all' : '').',@Tf'.cui.'_clrfmt_'.i.'_all,Tf_tok'
		" Define region that is begun by a start token
		exe 'syn region Tf'.cui.'_clr_'.i
			\.' start=/'.chi.'/'.r1_clr.' contains=Tf_tok'.ng.concealends
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_clr_'.i
			\.r2_clr.' contains=Tf_tok'.ng.concealends
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrbgc.' contains=Tf_tok'.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_clrbgc_'.i.'_'.j
				\.r2_clrbgc.' contains=Tf_tok'.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrbgcfmt.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_bgcfmt_'.j.'_'.k.',Tf'.cui.'_clrfmt_'.i.'_'.k.',Tf'.cui.'_clrbgc_'.i.'_'.j.',@Tf'.cui.'_bgcfmtclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_clrfmt.' contains=Tf_tok'.ng.concealends
			...
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_clrfmt_'.i.'_'.j
				\.r2_clrfmt.' contains=Tf_tok'.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_clrfmtbgc.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_fmtbgc_'.j.'_'.k.',Tf'.cui.'_clrbgc_'.i.'_'.k.',Tf'.cui.'_clrfmt_'.i.'_'.j.',@Tf'.cui.'_fmtbgcclr_'.j.'_'.k.'_all,@Tf'.cui.'_clrbgcfmt_'.i.'_'.k.'_all,@Tf'.cui.'_clrfmtbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while ip <= b:txtfmt_cfg_numbgcolors
		...
		" Cache the nextgroup clause
		let ng = ' nextgroup=@Tf'.cui.'_bgc_all'.(clr_enabled ? ',@Tf'.cui.'_bgcclr_'.i.'_all' : '').',@Tf'.cui.'_bgcfmt_'.i.'_all,Tf_tok'
		" Define region that is begun by a start token
		exe 'syn region Tf'.cui.'_bgc_'.i
			\.' start=/'.chi.'/'.r1_bgc.' contains=Tf_tok'.ng.concealends
		" Define region that is begun by an end token
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_bgc_'.i
			\.r2_bgc.' contains=Tf_tok'.ng.concealends
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		" handled correctly in a cterm.
		"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcclr.' contains=Tf_tok'.ng.concealends
			" Define region that is begun by an end token
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_bgcclr_'.i.'_'.j
				\.r2_bgcclr.' contains=Tf_tok'.ng.concealends
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			" handled correctly in a cterm.
			"	:help cterm-colors
			...
			while k <= b:txtfmt_num_formats - 1
				...
				exe 'syn region Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcclrfmt.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_clrfmt_'.j.'_'.k.',Tf'.cui.'_bgcfmt_'.i.'_'.k.',Tf'.cui.'_bgcclr_'.i.'_'.j.',@Tf'.cui.'_clrfmtbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while j <= b:txtfmt_num_formats - 1
			...
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_bgcfmt.' contains=Tf_tok'.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			...
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_bgcfmt_'.i.'_'.j
				\.r2_bgcfmt.' contains=Tf_tok'.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_bgcfmtclr.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_fmtclr_'.j.'_'.k.',Tf'.cui.'_bgcclr_'.i.'_'.k.',Tf'.cui.'_bgcfmt_'.i.'_'.j.',@Tf'.cui.'_fmtclrbgc_'.j.'_'.k.'_all,@Tf'.cui.'_bgcclrfmt_'.i.'_'.k.'_all,@Tf'.cui.'_bgcfmtclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
	...
	while i <= b:txtfmt_num_formats - 1
		...
		" Cache the nextgroup clause
		let ng = ' nextgroup=@Tf'.cui.'_fmt_all'.(clr_enabled ? ',@Tf'.cui.'_fmtclr_'.i.'_all' : '').(bgc_enabled ? ',@Tf'.cui.'_fmtbgc_'.i.'_all' : '').',Tf_tok'
		" Define region that is begun by a start token
		exe 'syn region Tf'.cui.'_fmt_'.i
			\.' start=/'.chi.'/'.r1_fmt.' contains=Tf_tok'.ng.concealends
		" Define the following region if and only if at least one of the
		" region types whose end token could begin this region is active
		"============= BEGIN NON-INDENTING BLOCK =============
		if clr_enabled || bgc_enabled
		...
		" (when permitted by a nextgroup)
		exe 'syn region Tf'.cui.'_fmt_'.i
			\.r2_fmt.' contains=Tf_tok'.ng.concealends
		endif " clr_enabled || bgc_enabled
		"=============  END NON-INDENTING BLOCK  =============
		" Define highlighting for this region
		" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
		...
		while jp <= b:txtfmt_cfg_numfgcolors
			...
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtclr.' contains=Tf_tok'.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if bgc_enabled
			...
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_fmtclr_'.i.'_'.j
				\.r2_fmtclr.' contains=Tf_tok'.ng.concealends
			endif " bgc_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numbgcolors
				...
				exe 'syn region Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtclrbgc.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_clrbgc_'.j.'_'.k.',Tf'.cui.'_fmtbgc_'.i.'_'.k.',Tf'.cui.'_fmtclr_'.i.'_'.j.',@Tf'.cui.'_clrbgcfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
		...
		while jp <= b:txtfmt_cfg_numbgcolors
			...
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j
				\.' start=/'.chj.'/'.r1_fmtbgc.' contains=Tf_tok'.ng.concealends
			" Define the following region if and only if at least one of the
			" region types whose end token could begin this region is active
			"============= BEGIN NON-INDENTING BLOCK =============
			if clr_enabled
			...
			" (when permitted by a nextgroup)
			exe 'syn region Tf'.cui.'_fmtbgc_'.i.'_'.j
				\.r2_fmtbgc.' contains=Tf_tok'.ng.concealends
			endif " clr_enabled
			"=============  END NON-INDENTING BLOCK  =============
			" Define highlighting for this region
			" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
			...
			while kp <= b:txtfmt_cfg_numfgcolors
				...
				exe 'syn region Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_'.k
					\.' start=/'.chk.'/'.r1_fmtbgcclr.' contains=Tf_tok'.' nextgroup=Tf'.cui.'_bgcclr_'.j.'_'.k.',Tf'.cui.'_fmtclr_'.i.'_'.k.',Tf'.cui.'_fmtbgc_'.i.'_'.j.',@Tf'.cui.'_bgcclrfmt_'.j.'_'.k.'_all,@Tf'.cui.'_fmtclrbgc_'.i.'_'.k.'_all,@Tf'.cui.'_fmtbgcclr_'.i.'_'.j.'_all'.concealends
				" Define highlighting for this region
				" Note: cterm= MUST come after ctermfg= to ensure that bold attribute is
				" handled correctly in a cterm.
				"	:help cterm-colors
